...
### 3. Go 模块配置
- ✅ 更新 `go.mod` 模块路径：`github.com/zhuchenglong/langchain-go`
- ✅ 更新 Go 版本：`go 1.22`
...
- Update module path to github.com/zhuchenglong/langchain-go
...
1. **进入 Releases 页面**
   - 访问：https://github.com/zhuchenglong/langchain-go/releases
...
- [ ] `go.mod` 模块路径正确：`github.com/zhuchenglong/langchain-go`
- [ ] README.md 中所有链接正确
- [ ] CHANGELOG.md 内容完整
- [ ] 文档结构清晰
- [ ] 示例代码可运行
