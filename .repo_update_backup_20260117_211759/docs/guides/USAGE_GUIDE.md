...
```bash
go get github.com/zhucl121/langchain-go/retrieval/chains
go get github.com/zhucl121/langchain-go/retrieval/retrievers
```
...
```go
import "github.com/zhucl121/langchain-go/retrieval/retrievers"
